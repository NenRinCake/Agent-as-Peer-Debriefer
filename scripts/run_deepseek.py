...
def call_deepseek_api(prompt, model="deepseek-reasoner", temperature=1):
    """
...
def fetch_data(perspective):
    ...
    for i in range(data_num):
        for j in range(trial_num):
            ...
            # code
            output_name = f"../output/dsv3.2-{datasets_name}-output/data%d_trial%d_code_output.json" % (i, j)
            ...
            # code_agent
            output_name = f"../output/dsv3.2-{datasets_name}-output/data%d_trial%d_{perspective}_agent_code_output.json" % (
            i, j)
            ...
            # sub-theme
            output_name = f"../output/dsv3.2-{datasets_name}-output/data%d_trial%d_{perspective}_subtheme_output.json" % (
            i, j)
            ...
            # sub-theme_agent
            output_name = f"../output/dsv3.2-{datasets_name}-output/data%d_trial%d_{perspective}_agent_subtheme_output.json" % (
            i, j)
            ...
            # theme
            output_name = f"../output/dsv3.2-{datasets_name}-output/data%d_trial%d_{perspective}_theme_output.json" % (i, j)
            ...
            # theme_agent
            output_name = f"../output/dsv3.2-{datasets_name}-output/data%d_trial%d_{perspective}_agent_theme_output.json" % (i, j)
